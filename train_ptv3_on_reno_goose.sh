...
#SBATCH --job-name train_ptv3_on_reno_Q8_goose
#SBATCH --nodes 1
...
sh scripts/train.sh -g 2 -d goose -c semseg-pt-v3m1-0-baseGooseOGModified -n pptv3_goose_${COMPRESSOR}_${Q_lvl}_jul8 -r true